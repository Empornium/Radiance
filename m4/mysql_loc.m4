...
[
	...
	AC_ARG_WITH(mysql,
		...
		MYSQL_inc_check+="/usr/include/mariadb /usr/local/include/mariadb /usr/local/mariadb/include /usr/local/mariadb/include/mariadb /usr/mariadb/include/mariadb /opt/mariadb/include/mariadb /sw/include/mariadb"])
